...
public class CashRegister {
    ...
    public void addProductToSale(Product product, int quantity) throws InsufficientQuantityException {
        ...
        if (product.getQuantity() < totalRequested) {
            throw new InsufficientQuantityException(product.getName(), totalRequested, product.getQuantity());
        }
        currentSale.put(product, totalRequested);
    }

    public Receipt completeSale(double customerMoney) {
